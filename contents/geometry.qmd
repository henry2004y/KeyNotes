...
![a) MVA (MGA) and b) MDD eigenvectors $\vec{n}_\mathrm{max},\vec{n}_\mathrm{mid},\vec{n}_\mathrm{min}$, corresponding to largest, middle and minimum eigenvalues in a 1-D current sheet.](../images/MVA_MDD.png){#fig-mva_mdd}
