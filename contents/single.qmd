...
| Mechanism | DSA | SDA | SSA | Betatron |
|------|------|------|-----|-----|
| Relation to $v$    | $\propto v_\perp^2$    | $\propto v$  | ? | $\propto v_\perp^2$ |

: Comparison between particle acceleration mechanisms {#tbl-acceleration}
