...
\end{aligned}
$$
where the integrated term has vanished by virtue of the definitions of $t_0$ and $\tau$, and @eq-pendulum has been used to substitute $\mathrm{d}^2 x/\mathrm{d}t^2$.
