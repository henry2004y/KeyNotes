...
Current theory suggests that the lower latitude region II current (compared with the region I current) is closely linked to the ring current. The ring current is generated from supra-thermal electrons and ions but not the thermal portion, thus requires extra care on the high energy tail distribution which may not be present in a model that only resolves the thermal part.
