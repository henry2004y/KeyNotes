...
$$
\lambda_{D}=\sqrt{\frac{\epsilon_0 k_B T^\ast}{e^2 n}}
$$
...
$$
\lambda_{D}=\sqrt{\frac{\epsilon_0 k_B T_e}{e^2 n}}
$$
which is only valid when the mobility of ions is negligible compared to the process's timescale.
