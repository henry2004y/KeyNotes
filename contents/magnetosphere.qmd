...
$$
where $P_\mathrm{dyn}$ is the solar wind dynamic pressure and b and c are empirical parameters, whose exact values depend on the used statistical analysis methods, e.g., $b = 7.26\,\mathrm{nT}\,\mathrm{nPa}^{−1/2}$ and $c = 11 nT$ as determined by O'Brien and McPherron (2000).
