...
As been discussed in @sec-flr, when the azimuthal wave number $m$, or $k_y$ in the box model is zero, there should be no mode coupling. However, this is not true if the finite temporal frequency $\omega$ is considered, as first noted by [Karney+ 1979].
