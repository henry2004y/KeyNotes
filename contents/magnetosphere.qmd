...
producing backstreaming ions (yellow dots), leaked magnetosheath ions (red dots), and upstream waves (wavy blue lines). The ion foreshock boundary is shown as the red line. [@wilson2016low]](../images/foreshock_configuration.png){#fig-foreshock}
