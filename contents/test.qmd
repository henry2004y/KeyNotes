...
In some cases, we need to convert from conservative variables to other set of variables, e.g. $(\rho,\mathbf{u},p,\mathbf{B})$. The density perturbation is $\rho_0\sin 2\pi x$. Assuming background $u_0=0$,
$$
