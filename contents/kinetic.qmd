...
The density is a function of four scalar variables, $n=n(\mathbf{r}, t)$, which is the integral of the distribution function over the velocity space:
$$
\begin{aligned}
...
This $\hat{f}$ is now a probability. Thus
$$
