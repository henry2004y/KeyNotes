...
| Time             | $t_0$         | $t_0=m_i/(e*B_0)$ | $1.04\times 10^{-3}\,\mathrm{s}$ |
| Mass density     | $\rho_0$      | $\rho_0=n_0/m_i$ | $1.67\times10^{-21}\,\mathrm{m}^{-3}$ |
| Pressure         | $p_0$         | $p_0=\rho_0v_0^2/2$ | $3.98\times10^{-11}\,\mathrm{N}\cdot\mathrm{m}^{-2}$ |
| Temperature      | $T_0$         | $T_0=p_0*m_i/(k_B\,\rho_0)$ | $2.88\times10^6\,\mathrm{K}$ |
