...
|----------------|----------|------------|-------|
| Magnetic field | $B_0$    | $B_0=B_\mathrm{ref}$ | $1\times10^{-9}\,\mathrm{T}$ |
...
|------------------|---------------|------------|-------|
| Length           | $l_0$         | $l_0=\sqrt{m_0/(\mu_0 e^2 n_0)}$ | $1\times10^2\,\mathrm{m}$ |
| Velocity         | $v_0$         | $v_0=B_0/\sqrt{\mu_0m_in_0}$| $2.18\times10^4\,\mathrm{m}\cdot\mathrm{s}^{-1}$|
| Time             | $t_0$         | $t_0=m_i/(e*B_0)$ | $4.59\times 10^{-3}\,\mathrm{s}$ |
| Mass density     | $\rho_0$      | $\rho_0=n_0/m_i$ | $1.67\times10^{-21}\,\mathrm{m}^{-3}$ |
| Pressure         | $p_0$         | $p_0=\rho_0v_0^2/2$ | $3.98\times10^{-13}\,\mathrm{N}\cdot\mathrm{m}^{-2}$ |
| Temperature      | $T_0$         | $T_0=p_0*m_i/(k_B\,\rho_0)$ | $2.88\times10^4\,\mathrm{K}$ |
