...
* Less Analytical Tractability: Strong turbulence is difficult, often impossible, to fully solve analytically. Numerical simulations and phenomenological modeling become essential tools.
...
The zero divergence means that there are no forcing or dissipation terms. Nonlinear interactions occur between the Alfvénic fluctuations $z^{\mp}$. Since we have already assumed uniform density in @eq-constrho-mhd, $v_A = B_0 / \rho = B_0$, we can write @eq-mhd_elsassar in an alternative form
$$
...
$$ {#eq-critical-balance}
This means that anisotropy grows with decreasing scale. It indicates the transition from “weak” to “strong” turbulence, or more accurately a transition from “quasi-linear” to “mode-coupling” processes. The power spectra are given as
$$
\begin{aligned}
