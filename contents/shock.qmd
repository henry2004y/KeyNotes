...
The categories of the solution of @eq-RH_planar_sol are shown in the following table. The $\pm$ signs denote the changes of the downstream compared with the upstream ($+$ means increase, $-$ means decrease).
