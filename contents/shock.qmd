...
Knowing that for the shock $U_n\neq 0$ and $\lfloor U_n \rceil \neq 0$, we can eliminate $\lfloor U_t \rceil$ from the [RH relations](https://en.wikipedia.org/wiki/Shocks_and_discontinuities_(magnetohydrodynamics)) and obtain
$$
