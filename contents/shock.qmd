...
::: {#tbl-foreshock layout-nrow=2}

|         | Depletion in n and B | Compression in n and B | Presence of suprathermal ions | Significant flow deflection | Significant plasma heating | Associated with an IMF discontinuity | Duration | Scale size |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| HFA          | Yes | At edges       | Yes | Yes | Yes | Yes | $10 - 10^2$ s | $\mathcal{O}(R_E)$ |
| SHFA         | Yes | At edges       | Yes | Yes | Yes | No  | $10 - 10^2$ s | $\mathcal{O}(R_E)$ |
| FB           | Yes | Only on the upstream edge | Yes | Yes | Yes | Yes | $10 - 10^2$ s | $\mathcal{O}(R_E)$ |
| Cavity       | Yes | At edges       | Yes | No  | Modest | Sometimes | $10 - 10^2$ s | $\mathcal{O}(R_E)$ |
| Caviton      | Yes | At edges       | Yes | No | No | No | $10 - 60$ s | $\mathcal{O}(R_E)$ |
| FCB          | Yes on the turbulent side | At edges | Maybe | No | No | No | $10 - 10^2$ s | $\mathcal{O}(R_E)$ |
| Density Hole | Yes | At edges       | Yes | Sometimes | Sometimes | Yes | $1 - 60$ s | $\mathcal{O}(R_E)$ |
| SLAMS        | No | Yes       | Maybe | Sometimes | Sometimes | No | $1 - 60$ s | up to $0.5\, R_E$? |

: Basic foreshock transient properties {#tbl-foreshock-transient-1}
...
: Foreshock transients generation mechanisms {#tbl-foreshock-transient-2}
