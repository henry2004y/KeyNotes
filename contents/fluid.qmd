...
\frac{\partial \rho\mathbf{u}}{\partial t} + \nabla\cdot\left( \rho\mathbf{u}\mathbf{u} - \mathbf{B}\mathbf{B} + p^\ast \right) = 0 \\
\frac{\partial \mathcal{E}}{\partial t} + \nabla\cdot\left[ (\mathcal{E} + p^\ast)\mathbf{u} - \mathbf{B}(\mathbf{B}\cdot\mathbf{u}) \right] = 0 \\
\frac{\partial \mathbf{B}}{\partial t} - \nabla\times(\mathbf{u}\times\mathbf{B}) = 0 \\
p^\ast = p + \frac{\mathbf{B}\cdot\mathbf{B}}{2} \\
\mathcal{E} = \frac{p}{\gamma - 1} + \frac{\rho \mathbf{u}\cdot\mathbf{u}}{2} + \frac{\mathbf{B}\cdot\mathbf{B}}{2}
\end{aligned}
$$ {#eq-ideal-mhd}
