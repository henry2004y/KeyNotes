...
Region II current is linked to the ring current around low latitude region. A simple MHD model does not have ring currents, which means it cannot have Region II currents. Region I currents, however, can be generated.
